<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <a href="/dashboard" class="text-blue-300">Back to dashboard</a>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-4 px-3">
                <h1 class="font-bold text-2xl text-red-500 pb-4">{{ $question->question }}</h1>
                ...
                <form action="{{ route('vote', ['question' => $question->id]) }}" method="POST">
                    ...
                    <button type="submit" class="text-white bg-blue-600 p-2">Vote</button>
                </form>
            </div>
        </div>
    </div>
